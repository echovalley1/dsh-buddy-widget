...
var css = [
  ...
  '.dshb-tail{position:absolute;left:50%;bottom:calc(var(--dshb-u) * -3 * var(--dshb-bub,1));width:calc(var(--dshb-u) * 7 * var(--dshb-bub,1));height:calc(var(--dshb-u) * 7 * var(--dshb-bub,1));margin-left:calc(var(--dshb-u) * -3.5 * var(--dshb-bub,1));background:#fff;border-right:calc(var(--dshb-u) * 2 * var(--dshb-bub,1)) solid #203170;border-bottom:calc(var(--dshb-u) * 2 * var(--dshb-bub,1)) solid #203170;border-bottom-right-radius:calc(var(--dshb-u) * 2 * var(--dshb-bub,1));transform:rotate(45deg);transform-origin:50% 50%;pointer-events:none;z-index:1}',
...
bubble.appendChild(tailEl) // 尾巴：JS 旋转指向图标中心点
